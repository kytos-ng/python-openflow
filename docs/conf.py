# -*- coding: utf-8 -*-
#
# python-openflow library documentation build configuration file, created by
...
htmlhelp_basename = 'python-openflowlibrarydoc'
...
latex_documents = [
    (master_doc, 'python-openflowlibrary.tex', u'python-openflow library Documentation',
...
man_pages = [
    (master_doc, 'python-openflowlibrary', u'python-openflow library Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'python-openflowlibrary', u'python-openflow library Documentation',
     author, 'python-openflowlibrary', 'One line description of project.',
     'Miscellaneous'),
]
